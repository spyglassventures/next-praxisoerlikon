    ...
    <section className='py-1 text-zinc-700 dark:text-zinc-300'>
      <div className='container'>
        ...
        <div className='mt-3 w-full max-w-full text-left relative -ml-4'>
          <h1 className='font-medium pt-5 text-zinc-900 dark:text-zinc-100'>Closed-Beta Test: Gutspracheart und Diagnose eingeben ➜ Formulierungsvorschlag für eine Kostengutsprache erhaltenen</h1>
        </div>
