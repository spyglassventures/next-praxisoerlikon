    ...
    initialMessages: [
      {
        ...
        über Wirkstoffe und deren Nebenwirkungen, sowie Interaktionen. Wenn möglich, gibst du auch Hinweise auf Alternativen und erstellen 
    ...
    <section className='py-1 text-zinc-700 dark:text-zinc-300'>
      <div className='container'>
        ...
        <div className='mt-3 w-full max-w-full text-left relative -ml-4'>
          <h1 className='font-medium pt-5 text-zinc-900 dark:text-zinc-100'>Closed-Beta Test: Medikament (optional: + Kontext) ➜ Infos zur Unverträglichkeiten/Nebenwirkungen.</h1>
        </div>
