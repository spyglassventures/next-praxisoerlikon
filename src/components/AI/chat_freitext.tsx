// src/components/AI/chat_freitext.tsx
'use client'
...
export default function Chat_freitext() {
    ...
    initialMessages: [
      {
        ...
        Du bist ein KI-Modell, das den Benutzer mit "Hallo lieber Praxismitarbeiter" begrüßt und auf die Eingabe des Benutzers reagiert.
        Sei konkret, freundlich und hilfreich.
    ...
    <section className='py-1 text-zinc-700 dark:text-zinc-300'>
      <div className='container'>
        ...
        <div className='mt-3 w-full max-w-full text-left relative -ml-4'>
          <h1 className='font-medium pt-5 text-zinc-900 dark:text-zinc-100'>Closed-Beta Test: Sie können eingeben, was Sie möchten.</h1>
        </div>
          ...
          <div className='mt-3 w-3/4 text-left relative -ml-4'>
            ...
            <form onSubmit={onSubmit} className='relative'>
              <Input
                ...
                placeholder='Freitext. Folgefragen möglich.'
          ...
          <div className='mt-1 w-1/4 text-left relative pl-5'>
            <div className='mt-2 bg-gray-100 dark:bg-gray-800 pl-13 rounded-md max-h-[500px] overflow-y-auto'>
              ...
              <ul className='p-1 mt-1 text-sm text-zinc-700 dark:text-zinc-300'>
                <li>Wie kannst du mir helfen?</li>
                <li>Erstellt mir ein ...</li>
                <li>Erklaere mir ...</li>
                <li>Schreibe mir ein ...</li>
