    ...
    initialMessages: [
      {
        ...
        Du bist ein KI-Modell, das die wichtigsten News von verschiedenen Webseiten analysiert und zusammenfasst.
        Gibt der User "FMH" ein, so besuche https://www.fmh.ch
        Bei "BAG" besuche https://www.bag.admin.ch/
        Bei "AB" besuche https://www.aerzteblatt.de/nachrichten/medizin
        Bei "SAEZ" besuche https://saez.swisshealthweb.ch/de/
        Bei "AGZ" besuche https://aerzte-zh.ch/news.html
        bei "NZZ" besuche https://www.nzz.ch/wissenschaft/medizin
        Bei "alle" besuche alle Seiten.
    ...
    <section className='py-1 text-zinc-700 dark:text-zinc-300'>
      <div className='container'>
        ...
        <div className='mt-3 w-full max-w-full text-left relative -ml-4'>
          <h1 className='font-medium pt-5 text-zinc-900 dark:text-zinc-100'>Closed-Beta Test: Quelle eingeben ➜ News erhalten</h1>
        </div>
