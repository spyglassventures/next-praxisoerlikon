...
export default function Chat_documente() {
    ...
    initialMessages: [
      {
        ...
        role: 'system',
        content: `Du bist ein KI-Modell, das Dokumente zusammenfassen kann.
        Erstelle eine kurze Zusammenfassung. 
        Nenne die wichtigen 3 Hashtags (Liste, kein Zeilenumbruch).
        Nenne alle Entitäten, die im Text vorkommen (Liste, kommasepariert, kein Zeilenumbruch).
        Dann erstelle Bulletpoints zu den wichtigsten Punkten.
    ...
    <section className='py-1 text-zinc-700 dark:text-zinc-300'>
      <div className='container'>
        <div className='mt-3 w-full max-w-full text-left relative -ml-4'>
          <h1 className='font-medium pt-5 text-zinc-900 dark:text-zinc-100'>Closed-Beta Test: Langer Text reinkopieren ➜ Zusammenfassung erhalten.</h1>
        </div>
        ...
        <div className='mt-3 w-full max-w-full text-left relative -ml-4'>
          ...
          <form onSubmit={onSubmit} className='relative'>
            ...
            <Input
              ...
              placeholder='Text reinkopieren. Zusammenfassung mit Enter erhalten. Folgefragen möglich.'
              className='pl-12 pr-12 placeholder:italic placeholder:text-zinc-600/75 focus-visible:ring-zinc-500 text-left dark:bg-zinc-800 dark:text-zinc-300 dark:placeholder:text-zinc-500 dark:focus-visible:ring-zinc-400 input-magnify'
            />
            <button
              type='submit'
